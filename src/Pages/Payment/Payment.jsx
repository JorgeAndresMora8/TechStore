...
import { ErrorMesage } from "./Components";
...
export default function Payment() {
  ...
  // const {  clearCart, cartItems, getCartTotal } = CartContextProvider()
  ...
  async function HandlePayment() {
    ...
    const paymentObj = createPaymentObj(getCartTotal(), getDate(), auth.email, cartItems)
